...
Je vous demande de mettre à niveau le type de mon compte "premuim" '> 
          ...
          <li class="sidebar-item active"><a class="sidebar-link" href="groupe.php"> 
              <svg class="svg-icon svg-icon-sm svg-icon-heavy me-2">
    ...
    <table class="table">
      ...
      <tbody>
        ...
        if (mysqli_num_rows($result) > 0) {
          ...
          <td>$dct</td>
          <td>$tce</td>
          <td><form action='sous_compte.php' method='post'><input type='hidden' name='id_v' value='$id'><input type='submit' value='voir'></form></td>
        </tr>";
           }
        }else {
          echo "<tr>
