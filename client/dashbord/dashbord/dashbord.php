<?php
session_start();
$birthday=$ps=$birthday0=$birthday1=$pass=$datee=$id_client_pere=$code=$code_pere=$date_cre=$Email=$first_N=$id_client=$last_N=$n_ccp=$N_d_c=$password=$price=$tlph=$type_c=$validation=$willaya="";
$nbr_son=$price=0;
    ...
    <nav class="side-navbar">
      <div class="side-navbar-inner">
        ...
        <ul class="list-unstyled">                  
          <li class="sidebar-item active"><a class="sidebar-link" href="dashbord.php"> 
            ...
            <div class="col-lg-4">
              ...
              <div class="card text-center h-100 mb-0">
                <div class="card-body">
                  ...
                  <p class="text-primary h2 fw-bold display-4"><?=$price?>,00 Da</p>
                  <p class="text-gray-700 display-7">Solde</p>
                  <p class="text-xs text-gray-600 mb-0">votre montant total .</p>
                </div>
              </div>
            </div>
            <div class="col-lg-4">
              ...
              <div class="card text-center h-100 mb-0">
                <div class="card-body">
                  ...
                  <p class="text-xs text-gray-600 mb-0">commission de 15% pour un compte basique<br>30% pour un compte premium  .</p>
                </div>
              </div>
            </div>
            <div class="col-lg-4">
              ...
              <div class="card text-center h-100 mb-0">
                <div class="card-body">
                   ...
                   <p class="text-gray-700 display-7">Pourcentage</p>
                  <h1 class="text-primary fw-bold display-4"><?=$ps?>%</h1> 
