		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-9 text-center mb-9">
					<h2 class="heading-section">tous mes clients</h2>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
							 ...
							 while($row = mysqli_fetch_assoc($result)) {
							  ...
							  <td >
								  ...
								  <div class='pl-3 '>
									...
									<td>
											<div class='pl-3 '>
											<form action='montant.php' method='get'>
											<input type='hidden' name='id_client' value='$id_client'>
											<input type='hidden' name='type_c' value='$type_c'>
											<input type='submit' class='btn col-12 btn-primary' value='valide compte' placeholder='xx'>
										  </form>
